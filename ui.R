# ui.R
# Author: G. Bharadwaja Kumar
# Date: 9 July 2020
# Description: Shiny UI, Coursera Data Science Capstone Final Project
# GitHub: https://github.com/bharadwajakumar/shinyapp
    ...
    navbarPage("Next Word Predict",
               ...
               tabPanel("About",
                        ...
                        div("Next Word Predict is a Shiny app that uses a text
                            ...
                            br(),
                            img(src = "github.png"),
                            a(target = "_blank", href = "https://github.com/bharadwajakumar/shiny-app/",
                            "Next Word Predict")),
                        br(),
                        h3("About Me"),
                        br(),
                        div("My name is G. Bharadwaja Kumar and I am working in the areas of data science and natural language processing",
                            br(),
                            br(),
                            )
               )
